...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Map<String, dynamic>> _getQuickActions() {
    switch (widget.role) {
      case Role.superAdmin:
        return [
          {
            "key": ScreenKey.attendanceDashboard,
            "label": "Att. DB",
        ...
        actions: [
          TextButton(
            ...
            child: const Text("Close",
                style: TextStyle(
                    color: Color(0xFF8B5BF6), fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final pillBgColor =
        isDark ? const Color(0xFF2E2657) : const Color(0xFFF5F4FF);
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
              ...
              children: [
                ...
                Text(widget.name.split(' ')[0],
                    style: const TextStyle(
                        ...
                        color: Colors.white)),
                const SizedBox(height: 2),
                Text("Tuesday, August 11, 2026 · ${roleLabels[widget.role]}",
                    style: TextStyle(
                  ...
                  children: quickActions.map((act) {
                    return Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () =>
                              widget.onNavigate(act["key"] as ScreenKey),
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
          ...
          if (isSuperAdmin)
            _buildSuperAdminView(isDark, cardColor, titleColor, subtitleColor,
                pillBgColor, pillBorderColor),
          if (isHoD) _buildHoDView(cardColor, titleColor, subtitleColor),
          if (isLecturer)
            _buildLecturerView(cardColor, titleColor, subtitleColor),
          if (isClassMonitor)
            _buildClassMonitorView(cardColor, titleColor, subtitleColor),
          if (isAssistant)
            _buildAssistantView(cardColor, titleColor, subtitleColor),
          ...
          if (!isSuperAdmin &&
            ...
            Row(
              children: [
                _buildStatCard("Present", "42", const Color(0xFF05CD99),
                    cardColor, subtitleColor),
                _buildStatCard("Late", "3", const Color(0xFFFFB547), cardColor,
                    subtitleColor),
                _buildStatCard("Absent", "2", const Color(0xFFEE5D50),
                    cardColor, subtitleColor),
              ],
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const LinearProgressIndicator(
                        value: 0.87,
                        backgroundColor: Color(0xFF2D255A),
                        color: Color(0xFF8B5BF6),
                        minHeight: 6),
                    const SizedBox(height: 6),
                    Text("Minimum requirement: 80%",
  ...
  Widget _buildSuperAdminView(bool isDark, Color cardColor, Color titleColor,
      Color subtitleColor, Color pillBgColor, Color pillBorderColor) {
    return Column(
      children: [
              ...
              children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.show_chart_rounded,
                            color: Color(0xFF8B5BF6), size: 20),
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () => _showModal(
                          "Missing Face Data (2 Users)",
                          Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              _buildUserTile("Kim Bopha", "Staff · F-009",
                                  titleColor, subtitleColor),
                              _buildUserTile("Noun Sopheak", "Staff · F-010",
                                  titleColor, subtitleColor),
                            ],
                          ),
                          isDark),
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text("Last backup: 2026-05-29 06:00",
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Center(
                  child: Text("11/11 attended · tap a number to see who",
                      style: TextStyle(fontSize: 11, color: subtitleColor)),
                ),
              ],
            ),
              ...
              children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.error_outline_rounded,
                            color: Color(0xFFEE5D50), size: 20),
                        const SizedBox(width: 8),
                      ...
                      child: const Row(
                        children: [
                          ...
                          Icon(Icons.chevron_right_rounded,
                              size: 16, color: Color(0xFF8B5BF6)),
                        ],
                      ),
                    ),
                  ],
                ...
                _buildAlertPillRow(
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text("Retrain notification sent to users")));
                }),
                _buildAlertPillRow(
                    "1 failed scan repeated 5 times (Pich Sambath)",
                    "Review",
                    const Color(0xFFEE5D50),
                    Icons.error_outline,
                    titleColor,
                ...
                _buildAlertPillRow(
                    "Backup older than 24h on secondary node",
                    "Run Backup",
                    const Color(0xFFFFB547),
                    ...
                    isDark, () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text("Backup initiated on secondary node")));
                }),
              ],
            ),
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _buildPrioBox("High", "2", "Face Retrain",
                        const Color(0xFFEE5D50), subtitleColor, isDark),
                    _buildPrioBox("Med", "2", "Leave", const Color(0xFFFFB547),
                        subtitleColor, isDark),
                    _buildPrioBox("Low", "2", "Permission",
                        const Color(0xFF63B3ED), subtitleColor, isDark),
                  ],
                ),
              ],
            ),
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildPillActionButton(
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text(
                              "Broadcast alert sent to all stakeholders")));
                    }),
                    _buildPillActionButton(
                        "Export Report",
                    ...
                    _buildPillActionButton("Restore", Icons.refresh_rounded,
                        pillBgColor, pillBorderColor, () {
  ...
  Widget _buildLecturerView(
      Color cardColor, Color titleColor, Color subtitleColor) {
    return Column(
      children: [
        Card(
          elevation: 0,
                ...
                ListTile(
                  ...
                  title: Text("Database Systems",
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color: titleColor)),
                  subtitle: Text("07:30–09:00 · B201",
                      style: TextStyle(fontSize: 11, color: subtitleColor)),
                  trailing: const Text("3/3 present",
                      style: TextStyle(
                          color: Color(0xFF05CD99),
                          fontWeight: FontWeight.bold)),
                ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  contentPadding: EdgeInsets.zero,
                  title: Text("Sok Pisey",
                      style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
                          color: titleColor)),
                  subtitle: Text("Duplicate scan · 07:42",
                      style: TextStyle(fontSize: 11, color: subtitleColor)),
  ...
  Widget _buildInteractiveMiniTile(String label, String value, Color color,
  ...
  Widget _buildAlertPillRow(String text, String btnLabel, Color accentColor,
      IconData icon, Color titleColor, bool isDark, VoidCallback onTap) {
    return Padding(
  ...
  Widget _buildPrioBox(String priority, String count, String label,
      Color accentColor, Color subtitleColor, bool isDark) {
    return Expanded(
      child: Container(
        padding: const EdgeInsets.all(12),
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: isDark ? const Color(0xFF3B326B) : Colors.grey.shade200),
        ),
        child: Column(
          children: [
            Row(
  ...
  Widget _buildPillActionButton(String label, IconData icon, Color pillBgColor,
      Color pillBorderColor, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
  ...
  Widget _buildUserTile(
      String name, String sub, Color titleColor, Color subtitleColor) {
    return ListTile(
      contentPadding: EdgeInsets.zero,
