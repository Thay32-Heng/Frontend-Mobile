        ...
        child: ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text("$_selectedRole (${list.length})",
                    style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: titleColor)),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon:
                    Icon(Icons.search_rounded, size: 20, color: subtitleColor),
                filled: true,
                fillColor: cardColor,
      ...
      child: ListView(
        ...
        children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.center_focus_strong_rounded,
                          color: Color(0xFF8B5BF6), size: 24),
                    ),
                    const SizedBox(height: 12),
                    Text("Face Retraining",
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: titleColor)),
                    const SizedBox(height: 4),
                    Text(
                      widget.retrainRequested
                          ? "Notification sent — users can now retrain."
                          : "Notify all stakeholders to retrain their face data.",
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: widget.retrainRequested
                            ? Colors.grey
                      ...
                      onPressed: widget.retrainRequested
                          ...
                          : () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        "Retrain notification sent to all stakeholders")),
                              );
                            },
                      child: Text(
          ...
          Padding(
            ...
            child: Text("Choose a stakeholder to manage",
                style: TextStyle(fontSize: 12, color: subtitleColor)),
          ),
          ...[
            "Head of Department",
