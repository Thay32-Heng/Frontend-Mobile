...
class _ClassAttendanceScreenState extends State<ClassAttendanceScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: const InputDecoration(
              hintText: "Add note…", border: OutlineInputBorder()),
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final rate = _roster.isEmpty
        ? 0
        : (((present + late) / _roster.length) * 100).round();
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          color: const Color(0x1A4318FF),
                          borderRadius: BorderRadius.circular(12)),
                      child: const Icon(Icons.calendar_today,
                          color: Color(0xFF4318FF), size: 20),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(_selectedSession.subject,
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF1B2559))),
                          Text(
                              "${_selectedSession.time} · ${_selectedSession.room}",
                              style: const TextStyle(
                  ...
                  return ListTile(
                    ...
                    trailing: isSelected
                        ? const Icon(Icons.check_circle,
                            color: Color(0xFF4318FF), size: 18)
                        : null,
                    onTap: () => setState(() {
                      _selectedSession = s;
                      _sessionOpen = false;
          ...
          Row(
            children: [
              _buildCountCard("Present", present, const Color(0xFF05CD99),
                  Icons.check_circle_outline),
              _buildCountCard(
                  "Late", late, const Color(0xFFFFB547), Icons.access_time),
              _buildCountCard("Absent", absent, const Color(0xFFEE5D50),
                  Icons.cancel_outlined),
              _buildCountCard("Leave", leave, const Color(0xFF63B3ED),
          ...
          if (_submitted)
            Container(
              ...
              decoration: BoxDecoration(
                  color: const Color(0x1A05CD99),
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(color: const Color(0x4D05CD99))),
              child: Row(
                children: [
                  const Icon(Icons.check_circle,
                      color: Color(0xFF05CD99), size: 18),
                  const SizedBox(width: 8),
                  Text("Attendance submitted · ${_selectedSession.subject}",
                      style: const TextStyle(
                          color: Color(0xFF05CD99),
                          fontWeight: FontWeight.bold,
                          fontSize: 12)),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Student Roster (Tap status to cycle)",
                      style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF1B2559))),
                  ...
                  ..._roster.map((s) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                          "In: ${s.checkIn}${s.note.isNotEmpty ? ' · ' + s.note : ''}",
                          style: const TextStyle(
                              fontSize: 11, color: Color(0xFF8F9BBA))),
                      trailing: Row(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text(
                                  "Attendance for ${_selectedSession.subject} submitted ($present present, $late late, $absent absent)")),
                        );
                      },
                    ),
                  ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(label,
                    style: const TextStyle(
                        fontSize: 10, color: Color(0xFF8F9BBA))),
              ],
            ),
          ),
        ),
