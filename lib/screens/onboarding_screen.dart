...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    final pwValid = _pwController.text.length >= 8 &&
                    ...
                    children: [
                      if (_step == 0) ...[
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                              fontSize: 13, color: Color(0xFF8F9BBA)),
                        ),
                        ...
                        Card(
                          ...
                          child: const Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("You'll do two quick things:",
                                    style: TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xFF1B2559))),
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.center_focus_strong,
                                        size: 16, color: Color(0xFF4318FF)),
                                    SizedBox(width: 8),
                                    Text("Capture your face from 3 angles",
                                        style: TextStyle(fontSize: 12)),
                                  ],
                                ),
                              ],
                                ...
                                const Row(
                                  children: [
                                    Icon(Icons.shield_outlined,
                                        size: 14, color: Color(0xFF8F9BBA)),
                                    SizedBox(width: 4),
                                    Text(
                                        "Min 8 chars. Use letters, numbers & symbols.",
                                        style: TextStyle(
                                            fontSize: 10,
                                            color: Color(0xFF8F9BBA))),
                                  ],
                                    ...
                                    children: [
                                      ...
                                      if (_capturing)
                                        Container(
                                          ...
                                          alignment: Alignment.center,
                                          child: Text("Capturing… $_captured/3",
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 13)),
                                        ),
