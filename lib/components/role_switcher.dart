...
final List<RoleEntry> roleEntries = [
  RoleEntry(
      ...
      dot: const Color(0xFF7551FF),
      pages: 11),
  RoleEntry(
      role: Role.headOfDepartment,
      label: "Head of Dept",
      email: "hod@school.edu",
      dot: const Color(0xFF4A90D9),
      pages: 8),
  RoleEntry(
      role: Role.lecturer,
      label: "Lecturer",
      ...
      pages: 7),
  RoleEntry(
      role: Role.classMonitor,
      label: "Class Monitor",
      email: "monitor@school.edu",
      dot: const Color(0xFFF39C12),
      pages: 6),
  RoleEntry(
      role: Role.assistant,
      label: "Assistant",
      email: "assistant@school.edu",
      dot: const Color(0xFF1ABC9C),
      pages: 7),
  RoleEntry(
      role: Role.staff,
      label: "Staff",
      email: "staff@school.edu",
      dot: const Color(0xFF95A5A6),
      pages: 5),
  RoleEntry(
      role: Role.student,
      label: "Student",
...
final Map<Role, List<PageCategory>> rolePagesMap = {
  ...
  Role.headOfDepartment: [
    PageCategory("MAIN", ["Dashboard"]),
    PageCategory(
        "ATTENDANCE", ["Face Capture", "Att. Dashboard", "Att. History"]),
  ...
  Role.lecturer: [
    PageCategory("MAIN", ["Dashboard"]),
    PageCategory("ATTENDANCE",
        ["Face Capture", "Att. Marking", "Class Attendance", "Att. History"]),
    PageCategory("MANAGEMENT", ["Request", "Report"]),
  ],
  Role.classMonitor: [
    PageCategory("MAIN", ["Dashboard"]),
    PageCategory(
        "ATTENDANCE", ["Face Capture", "Class Attendance", "Att. History"]),
    PageCategory("MANAGEMENT", ["Request", "Report"]),
  ],
  Role.assistant: [
    PageCategory("MAIN", ["Dashboard"]),
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isPreviewed
                                          ? const Color(0x2E7551FF)
                                          : Colors.transparent,
                                      borderRadius: BorderRadius.circular(12),
                                      border: Border.all(
                                        color: isPreviewed
                                            ? const Color(0x737551FF)
                                            : Colors.transparent,
                                        width: 1.5,
                                      ),
                                    ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("Switch to ${previewEntry.label}",
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white,
                                      fontSize: 13)),
